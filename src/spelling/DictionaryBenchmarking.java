...
public class DictionaryBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			/*
			 * long startTime = System.nanoTime(); for (int i = 0; i < trials; i++) {
			 * llDict.isWord(notInDictionary); } long endTime = System.nanoTime(); long
			...
			System.out.println(numToCheck + "\t" + timeBST);
