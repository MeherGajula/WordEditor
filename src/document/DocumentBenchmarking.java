...
public class DocumentBenchmarking {
	...
	public static double fleschScore ;
				...
				numToCheck += increment)
		{
			 ...
			 */  
				...
				System.out.print(numToCheck + "\t");
				  ...
				  //BasicDoc time 
				  BasicDocument bd = new BasicDocument(testFile) ;
				 
				  long startTime = System.nanoTime(); 
				  for(int j=0; j<trials; j++) {
					
				  fleschScore = bd.getFleschScore(); 
				  }
				...
				//efficientDoc time
				  ...
				  EfficientDocument ed = new EfficientDocument(testFile); 
				 startTime = System.nanoTime(); 
				 for(int j=0; j<trials;j++) {
					
				 fleschScore = ed.getFleschScore();
				 }
